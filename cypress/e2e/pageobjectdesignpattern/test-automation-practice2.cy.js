...
describe('Test Automation Practice Validation  - TestCase2', ()=> {
    ...
    it('Enter Address', ()=> {
        ...
        test_Auto_Practice.enterAddress('Hyderabad')
    });
