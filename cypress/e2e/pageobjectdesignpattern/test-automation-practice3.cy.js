...
describe('Test Automation Practice Validation - TestCase3', ()=> {
    ...
    it('Enter Address', ()=> {
        ...
        test_Auto_Practice.enterAddress('Chennai')
    });
